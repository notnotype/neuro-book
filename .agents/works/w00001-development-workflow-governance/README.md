...
已收尾：`master` 上的合入提交 `836979cd`（技能与协作精简）、`1ec1a8b8`（Lab 显式契约与治理文档）、`1b677f77`（AgentSidebar fixture 修复）、`5c8f11cf`（nb-harness 包规则）及 `cb584e08`（最终证据快照）。待清理：`.worktree/w00001-development-workflow-governance`、`feat/w00001-docs-anchor-check`。删除 worktree 与分支仍需开发者明确授权。
