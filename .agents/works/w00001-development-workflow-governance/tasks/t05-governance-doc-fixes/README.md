...
非目标：DOC-H1/H2/H3、WF-002/003/008 等需开发者取舍的项；`packages/nb-harness/AGENTS.md` 的包定位措辞。

## 当前状态

改动未提交，与 t04 同在 `.worktree/w00001-development-workflow-governance`、分支 `feat/w00001-docs-anchor-check`；未获本 Task 的提交授权。
