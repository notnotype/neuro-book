...
export function createBuiltinEditorContributions(bindings: BuiltinEditorBindings): readonly EditorContribution[] {
    return [{
        ...
        render: (props, events, bind) => h(CodeEditorView, {
            ...props, monacoPreferences: bindings.code.preferences(), temporaryFontSize: bindings.code.temporaryFontSize(props.document.target.path),
            onChange: events.change, onSave: events.save, onFocus: events.focus, onReady: bind,
        ...
        render: (props, events, bind) => h(MarkdownEditorView, {
            ...props, editorPreferences: bindings.markdown.preferences(), showFrontmatterPanel: bindings.markdown.canEditFrontmatter(props.document.target),
            ...
            onChange: events.change, onSave: events.save, onFocus: events.focus, onActions: events.actions, onReady: bind,
