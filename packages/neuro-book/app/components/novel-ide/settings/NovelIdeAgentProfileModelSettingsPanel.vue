...
} from "nbook/app/components/novel-ide/settings/sections/agent-profile/profile-runtime-settings";
import {
...
} from "nbook/app/components/novel-ide/settings/sections/agent-profile/agent-profile-draft";
                ...
                <Transition name="fade-slide" mode="out-in">
                    ...
                    <div v-if="activeProfile" :key="activeProfile.profileKey">
                        <AgentProfileDetailPanel
                            ...
                            :scope="props.scope"
                            :runtime-baseline="{settings: activeProfile.runtimeEffective, sources: activeProfile.runtimeSources}"
                            :descriptions="{}"
