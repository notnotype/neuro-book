...
<template>
    <!-- 消息级分支切换器：上一条 / 计数 / 下一条 -->
    <div class="inline-flex h-7 shrink-0 items-center overflow-hidden rounded-md border border-[var(--border-color)] bg-[var(--bg-subtle)] text-[var(--text-muted)]" :title="title">
