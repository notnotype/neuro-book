...
<template>
    ...
    >
        ...
        <AgentComposer
            ...
            :context-usage-exact-label="props.composer.contextUsageExactLabel"
            :context-usage-compact-label="props.composer.contextUsageCompactLabel"
            :context-percent-compact-label="props.composer.contextPercentCompactLabel"
            :cumulative-usage-exact-label="props.composer.cumulativeUsageExactLabel"
            :cumulative-input-compact-label="props.composer.cumulativeInputCompactLabel"
            :cumulative-output-compact-label="props.composer.cumulativeOutputCompactLabel"
            :cumulative-cache-compact-label="props.composer.cumulativeCacheCompactLabel"
            :cumulative-cache-write-compact-label="props.composer.cumulativeCacheWriteCompactLabel"
            :cumulative-cache-hit-rate-label="props.composer.cumulativeCacheHitRateLabel"
            :cumulative-cost-compact-label="props.composer.cumulativeCostCompactLabel"
            :connection-status-label="props.composer.connectionStatusLabel"
            :run-phase-label="props.composer.runPhaseLabel"
            :connection-needs-action="props.composer.connectionNeedsAction"
