...
<template>
    ...
    <Dialog :model-value="modelValue" size="lg" :title="title" closable teleport-target=".novel-ide-theme" :busy="busy" :close-on-overlay="false" overlay-type="opaque" @request-close="close">
