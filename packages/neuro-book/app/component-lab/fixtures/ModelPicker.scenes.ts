...
const extendedRoles: ModelPickerRoleItem[] = [
    ...MODEL_PICKER_ROLES,
    {...MODEL_PICKER_ROLES[4]!, id: "research", name: "考据", description: "背景资料与事实校验"},
    {...MODEL_PICKER_ROLES[4]!, id: "dialogue", name: "对白", description: "角色对话与语气"},
];
...
export const modelPickerContentScenes = [
    ...
    {id: "specialist-enabled", label: "全部角色与模型", input: {props: {...contentProps, roles: extendedRoles}, model: {modelValue: "role:writer", thinkingLevel: "high"}}},
...
export const modelPickerPopoverScenes = [
    ...
    {id: "specialist-enabled", label: "含专精轴角色", input: {props: {...popoverProps, roles: extendedRoles}, model: {open: true, modelValue: "role:plan", thinkingLevel: "high"}}},
