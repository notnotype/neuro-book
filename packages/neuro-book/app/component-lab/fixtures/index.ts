...
export const labFixtures: LabFixture[] = [
    ...
    },
    {
        ...
        scenes: [
            ...
            {id: "cosmos", label: "方案三：世界罗盘星图", data: {editable: "fixture-owned"}},
            {id: "zen", label: "方案四：极简禅宗手稿", data: {editable: "fixture-owned"}},
            {id: "chronicle", label: "方案五：时间走廊胶卷", data: {editable: "fixture-owned"}},
