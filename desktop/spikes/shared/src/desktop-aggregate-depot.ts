...
export const DESKTOP_AGGREGATE_DEPOT_ARCHIVE = "neuro-book-desktop-spike-win-x64.zip";
export const DESKTOP_AGGREGATE_DEPOT_MANIFEST = "neuro-book-desktop-spike-win-x64.manifest.json";
export const DESKTOP_AGGREGATE_DEPOT_DISTRIBUTION_MANIFEST = "neuro-book-desktop-spike-win-x64.distribution.json";
